...
UrlDownloadToFile http://kabby.xyz/DSA_Keybinder/Version.txt, version.txt
...
if(SERVERDOWN == 1){
	...
	IfMsgBox, YES
	{
		...
		UrlDownloadToFile http://kabby.xyz/DSA_Keybinder/Keybinder.exe, %A_ScriptName%.new
		UpdateBat=
			(
				Del "%A_ScriptName%"
...
IfNotExist, %A_AppData%\Keybinder\DSA_Keybinder\config\
{
	FileCreateDir, %A_AppData%\Keybinder\DSA_Keybinder\config\
}
/*
IfNotExist %A_AppData%\Keybinder\DSA_Keybinder\blau.jpg
{
	URLDownloadToFile, http://kabby.xyz/DSA_Keybinder/blau.jpg, %A_AppData%\Keybinder\DSA_Keybinder\blau.jpg
}

IfNotExist %A_AppData%\Keybinder\DSA_Keybinder\grau.jpg
{
	URLDownloadToFile, http://kabby.xyz/DSA_Keybinder/grau.jpg, %A_AppData%\Keybinder\DSA_Keybinder\grau.jpg
}

IfNotExist %A_AppData%\Keybinder\Open-SAMP-API.dll
{
	URLDownloadToFile, http://kabby.xyz/DSA_Keybinder/Open-SAMP-API.dll, %A_AppData%\Keybinder\Open-SAMP-API.dll
	Reload
}
*/
...
SendBind(i){
	IniRead, myKills, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, KillCounter, Anzahl
	IniRead, myDeaths, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, DeathCounter, Anzahl
	ID := getPlayerID()
...
IniRead, Key01, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key01
if(Key01 == "ERROR" || Key01 == ""){
	Key01 := ""
	IniWrite, %Key01%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key01
}
IniRead, Key02, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key02
if(Key02 == "ERROR" || Key02 == ""){
	Key02 := ""
	IniWrite, %Key02%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key02
}
IniRead, Key03, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key03
if(Key03 == "ERROR" || Key03 == ""){
	Key03 := ""
	IniWrite, %Key03%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key03
}
IniRead, Key04, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key04
if(Key04 == "ERROR" || Key04 == ""){
	Key04 := ""
	IniWrite, %Key04%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key04
}
IniRead, Key05, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key05
if(Key05 == "ERROR" || Key05 == ""){
	Key05 := ""
	IniWrite, %Key05%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key05
}
IniRead, Key06, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key06
if(Key06 == "ERROR" || Key06 == ""){
	Key06 := ""
	IniWrite, %Key06%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key06
}
IniRead, Key07, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key07
if(Key07 == "ERROR" || Key07 == ""){
	Key07 := ""
	IniWrite, %Key07%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key07
}
IniRead, Key08, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key08
if(Key08 == "ERROR" || Key08 == ""){
	Key08 := ""
	IniWrite, %Key08%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key08
}
IniRead, Key09, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key09
if(Key09 == "ERROR" || Key09 == ""){
	Key09 := ""
	IniWrite, %Key09%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key09
}
IniRead, Key10, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key10
if(Key10 == "ERROR" || Key10 == ""){
	Key10 := ""
	IniWrite, %Key10%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key10
}
IniRead, Key11, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key11
if(Key11 == "ERROR" || Key11 == ""){
	Key11 := ""
	IniWrite, %Key11%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key11
}
IniRead, Key12, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key12
if(Key12 == "ERROR" || Key12 == ""){
	Key12 := ""
	IniWrite, %Key12%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key12
}
IniRead, Key13, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key13
if(Key13 == "ERROR" || Key13 == ""){
	Key13 := ""
	IniWrite, %Key13%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key13
}
IniRead, Key14, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key14
if(Key14 == "ERROR" || Key14 == ""){
	Key14 := ""
	IniWrite, %Key14%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key14
}
IniRead, Key15, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key15
if(Key15 == "ERROR" || Key15 == ""){
	Key15 := ""
	IniWrite, %Key15%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key15
}
IniRead, Key16, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key16
if(Key16 == "ERROR" || Key16 == ""){
	Key16 := ""
	IniWrite, %Key16%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key16
}
IniRead, Key17, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key17
if(Key17 == "ERROR" || Key17 == ""){
	Key17 := ""
	IniWrite, %Key17%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key17
}
IniRead, Key18, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key18
if(Key18 == "ERROR" || Key18 == ""){
	Key18 := ""
	IniWrite, %Key18%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key18
}
IniRead, Key19, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key19
if(Key19 == "ERROR" || Key19 == ""){
	Key19 := ""
	IniWrite, %Key19%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key19
}
IniRead, Key20, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key20
if(Key20 == "ERROR" || Key20 == ""){
	Key20 := ""
	IniWrite, %Key20%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Hotkeys, Key20
}
IniRead, TextString01, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 01
if(TextString01 == "ERROR"){
	TextString01 := ""
	IniWrite, %TextString01%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 01
}
IniRead, TextString02, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 02
if(TextString02 == "ERROR"){
	TextString02 := ""
	IniWrite, %TextString02%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 02
}
IniRead, TextString03, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 03
if(TextString03 == "ERROR"){
	TextString03 := ""
	IniWrite, %TextString03%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 03
}
IniRead, TextString04, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 04
if(TextString04 == "ERROR"){
	TextString04 := ""
	IniWrite, %TextString04%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 04
}
IniRead, TextString05, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 05
if(TextString05 == "ERROR"){
	TextString05 := ""
	IniWrite, %TextString05%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 05
}
IniRead, TextString06, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 06
if(TextString06 == "ERROR"){
	TextString06 := ""
	IniWrite, %TextString06%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 06
}
IniRead, TextString07, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 07
if(TextString07 == "ERROR"){
	TextString07 := ""
	IniWrite, %TextString07%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 07
}
IniRead, TextString08, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 08
if(TextString08 == "ERROR"){
	TextString08 := ""
	IniWrite, %TextString08%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 08
}
IniRead, TextString09, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 09
if(TextString09 == "ERROR"){
	TextString09 := ""
	IniWrite, %TextString09%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 09
}
IniRead, TextString10, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 10
if(TextString10 == "ERROR"){
	TextString10 := ""
	IniWrite, %TextString10%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 10
}
IniRead, TextString11, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 11
if(TextString11 == "ERROR"){
	TextString11 := ""
	IniWrite, %TextString11%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 11
}
IniRead, TextString12, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 12
if(TextString12 == "ERROR"){
	TextString12 := ""
	IniWrite, %TextString12%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 12
}
IniRead, TextString13, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 13
if(TextString13 == "ERROR"){
	TextString13 := ""
	IniWrite, %TextString13%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 13
}
IniRead, TextString14, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 14
if(TextString14 == "ERROR"){
	TextString14 := ""
	IniWrite, %TextString14%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 14
}
IniRead, TextString15, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 15
if(TextString15 == "ERROR"){
	TextString15 := ""
	IniWrite, %TextString15%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 15
}
IniRead, TextString16, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 16
if(TextString16 == "ERROR"){
	TextString16 := ""
	IniWrite, %TextString16%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 16
}
IniRead, TextString17, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 17
if(TextString17 == "ERROR"){
	TextString17 := ""
	IniWrite, %TextString17%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 17
}
IniRead, TextString18, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 18
if(TextString18 == "ERROR"){
	TextString18 := ""
	IniWrite, %TextString18%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 18
}
IniRead, TextString19, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 19
if(TextString19 == "ERROR"){
	TextString19 := ""
	IniWrite, %TextString19%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 19
}
IniRead, TextString20, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 20
if(TextString20 == "ERROR"){
	TextString20 := ""
	IniWrite, %TextString20%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Text, 20
}
IniRead, AEngine, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, Automatic, Engine
if(AEngine == "ERROR" || AEngine == ""){
	AEngine := 1
	IniWrite, %AEngine%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, Automatic, Engine
}
IniRead, AZoll, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, Automatic, Zoll
if(AZoll == "ERROR" || AZoll == ""){
	AZoll := 1
	IniWrite, %AZoll%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, Automatic, Zoll
}
IniRead, TogKey, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Others, ToggleKey
if(TogKey == "ERROR" || TogKey == ""){
	TogKey := F12
	IniWrite, %TogKey%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Others, ToggleKey
}
IniRead, OV, %A_AppData%\Keybinder\DSA_Keybinder\config\Overlay.ini, Overlay Settings, Status
if(OV == "ERROR" || OV == ""){
	OV := 0
	IniWrite, %OV%, %A_AppData%\Keybinder\DSA_Keybinder\config\Overlay.ini, Overlay Settings, Status
}
IniRead, OVcolor, %A_AppData%\Keybinder\DSA_Keybinder\config\Overlay.ini, Overlay Settings, Color
if(OVcolor == "ERROR" || OVcolor == ""){
	OVcolor := 2
	IniWrite, %OVcolor%, %A_AppData%\Keybinder\DSA_Keybinder\config\Overlay.ini, Overlay Settings, Color
}
IniRead, OVsize, %A_AppData%\Keybinder\DSA_Keybinder\config\Overlay.ini, Overlay Settings, Size
if(OVsize == "ERROR" || OVsize == ""){
	OVsize := 8
	IniWrite, %OVsize%, %A_AppData%\Keybinder\DSA_Keybinder\config\Overlay.ini, Overlay Settings, Size
}
IniRead, 1kx, %A_AppData%\Keybinder\DSA_Keybinder\config\Overlay.ini, Overlay Settings, X
if(1kx == "ERROR" || 1kx == ""){
	1kx := 15
	IniWrite, %1kx%, %A_AppData%\Keybinder\DSA_Keybinder\config\Overlay.ini, Overlay Settings, X
}
IniRead, 1ky, %A_AppData%\Keybinder\DSA_Keybinder\config\Overlay.ini, Overlay Settings, Y
if(1ky == "ERROR" || 1ky == ""){
	1ky := 250
	IniWrite, %1ky%, %A_AppData%\Keybinder\DSA_Keybinder\config\Overlay.ini, Overlay Settings, Y
}
IniRead, killMsgPrivate, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, KillCounter, Private
if(killMsgPrivate == "ERROR" || killMsgPrivate == ""){
	killMsgPrivate := 0
	IniWrite, %killMsgPrivate%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, KillCounter, Private
}
IniRead, killMsgPublic, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, KillCounter, Public
if(killMsgPublic == "ERROR" || killMsgPublic == ""){
	killMsgPublic := 0
	IniWrite, %killMsgPublic%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, KillCounter, Public
}
IniRead, killMsgFraktion, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, KillCounter, Fraktion
if(killMsgFraktion == "ERROR" || killMsgFraktion == ""){
	killMsgFraktion := 0
	IniWrite, %killMsgFraktion%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, KillCounter, Fraktion
}
IniRead, deathMsgPrivate, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, DeathCounter, Private
if(deathMsgPrivate == "ERROR" || deathMsgPrivate == ""){
	deathMsgPrivate := 0
	IniWrite, %deathMsgPrivate%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, DeathCounter, Private
}
IniRead, deathMsgPublic, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, DeathCounter, Public
if(deathMsgPublic == "ERROR" || deathMsgPublic == ""){
	deathMsgPublic := 0
	IniWrite, %deathMsgPublic%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, DeathCounter, Public
}
IniRead, deathMsgFraktion, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, DeathCounter, Fraktion
if(deathMsgFraktion == "ERROR" || deathMsgFraktion == ""){
	deathMsgFraktion := 0
	IniWrite, %deathMsgFraktion%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, DeathCounter, Fraktion
}
IniRead, myKills, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, KillCounter, Anzahl
if(myKills == "ERROR" || myKills == ""){
	myKills := 0
	IniWrite, %myKills%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, KillCounter, Anzahl
}
IniRead, myDeaths, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, DeathCounter, Anzahl
if(myDeaths == "ERROR" || myDeaths == ""){
	myDeaths := 0
	IniWrite, %myDeaths%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, DeathCounter, Anzahl
}
IniRead, KillMSG, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, KillCounter, Nachricht
if(KillMSG == "ERROR" || KillMSG == ""){
	KillMSG := "Bruder bei mir läuft! Kills Nr. [kills]"
	IniWrite, %KillMSG%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, KillCounter, Nachricht
}
IniRead, deathMSG, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, DeathCounter, Nachricht
if(deathMSG == "ERROR" || deathMSG == ""){
	deathMSG := "SHIT! Ich bin verreckt!!! Tod Nr. [deaths]"
	IniWrite, %deathMSG%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, DeathCounter, Nachricht
}
IniRead, DeteKey, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Others, DeteKey
if(DeteKey == "ERROR" || DeteKey == ""){
	DeteKey :=
	IniWrite, %DeteKey%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Others, DeteKey
}
IniRead, runKey, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, Laufscript, runKey
if(runKey == "ERROR" || runKey == ""){
	runKey := 1
	IniWrite, %runKey%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, Laufscript, runKey
}
IniRead, Adminrang, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Admin, Rang
if(Adminrang == "ERROR" || Adminrang == ""){
	Adminrang := 1
	IniWrite, %Adminrang%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Admin, Rang
}
IniRead, Ticket, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Admin, Ticket
if(Ticket == "ERROR" || Ticket == ""){
	Ticket := 0
	IniWrite, %Ticket%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Admin, Ticket
}
IniRead, Waffendealer, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Skills, Waffendealer
if(Waffendealer == "ERROR" || Waffendealer == ""){
	Waffendealer := 1
	IniWrite, %Waffendealer%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Skills, Waffendealer
}
IniRead, Drogendealer, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Skills, Drogendealer
if(Drogendealer == "ERROR" || Drogendealer == ""){
	Drogendealer := 1
	IniWrite, %Drogendealer%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Skills, Drogendealer
}
IniRead, Detektiv, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Skills, Detektiv
if(Detektiv == "ERROR" || Detektiv == ""){
	Detektiv := 1
	IniWrite, %Detektiv%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Skills, Detektiv
}
IniRead, Anwalt, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Skills, Anwalt
if(Anwalt == "ERROR" || Anwalt == ""){
	Anwalt := 1
	IniWrite, %Anwalt%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Skills, Anwalt
}
IniRead, Fraktion, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Fraktion, Frak
if(Fraktion == "ERROR" || Fraktion == ""){
	Fraktion := 1
	IniWrite, %Fraktion%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Fraktion, Frak
}
IniRead, FRang, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Fraktion, Rang
if(FRang == "ERROR" || FRang == ""){
	FRang := 1
	IniWrite, %FRang%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Fraktion, Rang
}
IniRead, Waffenteile, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, Waffenteile
if(Waffenteile == "ERROR" || Waffenteile == ""){
	Waffenteile := 0
	IniWrite, %Waffenteile%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, Waffenteile
}
IniRead, Drogen, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, Drogen
if(Drogen == "ERROR" || Drogen == ""){
	Drogen := 0
	IniWrite, %Drogen%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, Drogen
}
IniRead, Spice, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, Spice
if(Spice == "ERROR" || Spice == ""){
	Spice := 0
	IniWrite, %Spice%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, Spice
}
IniRead, Wantedcodes, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, Wantedcodes
if(Wantedcodes == "ERROR" || Wantedcodes == ""){
	Wantedcodes := 0
	IniWrite, %Wantedcodes%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, Wantedcodes
}
IniRead, Kekse, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, Kekse
if(Kekse == "ERROR" || Kekse == ""){
	Kekse := 0
	IniWrite, %Kekse%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, Kekse
}
IniRead, WaffenteileSB, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, WaffenteileSB
if(WaffenteileSB == "ERROR" || WaffenteileSB == ""){
	WaffenteileSB := 0
	IniWrite, %WaffenteileSB%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, WaffenteileSB
}
IniRead, DrogenSB, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, DrogenSB
if(DrogenSB == "ERROR" || DrogenSB == ""){
	DrogenSB := 0
	IniWrite, %DrogenSB%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, DrogenSB
}
IniRead, SpiceSB, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, SpiceSB
if(SpiceSB == "ERROR" || SpiceSB == ""){
	SpiceSB := 0
	IniWrite, %SpiceSB%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, SpiceSB
}
IniRead, WantedcodesSB, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, WantedcodesSB
if(WantedcodesSB == "ERROR" || WantedcodesSB == ""){
	WantedcodesSB := 0
	IniWrite, %WantedcodesSB%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Inventar, WantedcodesSB
}
IniRead, KekseKey, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Others, KekseKey
if(KekseKey == "ERROR" || KekseKey == ""){
	KekseKey :=
	IniWrite, %KekseKey%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Others, KekseKey
}
IniRead, SpiceKey, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Others, SpiceKey
if(SpiceKey == "ERROR" || SpiceKey == ""){
	SpiceKey :=
	IniWrite, %SpiceKey%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Others, SpiceKey
}
IniRead, IntKey, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Others, IntKey
if(IntKey == "ERROR" || IntKey == ""){
	IntKey :=
	IniWrite, %IntKey%, %A_AppData%\Keybinder\DSA_Keybinder\config\Hotkeys.ini, Others, IntKey
}
...
Gui, Destroy
Gui, Color, FFFFFFF
Gui, Add, Picture, x0 y0 w910 h20 , %A_AppData%\Keybinder\DSA_Keybinder\blau.jpg
Gui, Add, Picture, x0 y440 w900 h50 , %A_AppData%\Keybinder\DSA_Keybinder\grau.jpg
...
Gui, Add, Text, x2 y-1 w770 h40 cWhite +Center +BackgroundTrans, Dreams of San Andreas Keybinder
...
Gui, Show, w775 h490, Dreams of San Andreas Keybinder | Home
return

Help:
Gui, Destroy
Gui, Color, FFFFFFF
Gui, Add, Text, x2 y-1 w470 h30 +Center, Dreams of San Andreas Keybinder - Help
...
Gui, Show, w476 h384, Dreams of San Andreas Keybinder | Help
return

Befehle:
Gui, Destroy
Gui, Color, FFFFFFF
Gui, Add, Text, x2 y-1 w470 h30 +Center, Dreams of San Andreas Keybinder - Weitere Befehle
if(Adminrang > "1"){
...
Gui, Add, Button, x312 y349 w160 h30 gAbord, Zurück
Gui, Show, w476 h384, Dreams of San Andreas Keybinder | Weitere Befehle
return
...
Variablen:
MsgBox, 0, Dreams of San Andreas Keybinder | Variablen, Variablen für den Dreams of San Andreas Keybinder:`n`n [ID] = ID`n [Zone] = Zone`n [City] = City`n [VehType] = Fahrzeug Typ`n [Kills] = Kills`n [Deaths] = Deaths
return

Settings:
Gui, Destroy
Gui, Color, FFFFFFF
Gui, Add, Picture, x-8 y-1 w1450 h50 , %A_AppData%\Keybinder\DSA_Keybinder\blau.jpg
Gui, Add, Picture, x-8 y559 w780 h60 , %A_AppData%\Keybinder\DSA_Keybinder\grau.jpg
Gui, Add, Text, x236 y9 w280 h20 cWhite +Center +BackgroundTrans, Dreams of San Andreas Keybinder | Einstellungen
...
Gui, Destroy
Gui, Color, FFFFFFF
Gui, Add, Text, x2 y-1 w460 h30 +Center, Dreams of San Andreas Keybinder Einstellungen
...
Gui, Show, w466 h524, Dreams of San Andreas Keybinder | Settings
return
*/
...
IniWrite, %OVcolorVar%, %A_AppData%\Keybinder\DSA_Keybinder\config\Overlay.ini, Overlay Settings, Color
...
Gui, Add, Picture, x-8 y-1 w910 h50 , %A_AppData%\Keybinder\DSA_Keybinder\blau.jpg
Gui, Add, Picture, x-8 y549 w900 h50 , %A_AppData%\Keybinder\DSA_Keybinder\grau.jpg
Gui, Add, Text, x230 y9 w420 h40 cWhite +Center +BackgroundTrans, Dreams of San Andreas Keybinder
...
Gui, Show, w891 h598, Dreams of San Andreas Keybinder | Stats
return
...
IniWrite, %AdminrangVar%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Admin, Rang
...
IniWrite, %FraktionVar%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Fraktion, Frak
GuiControlGet, FRang
if(FRang == "0"){
	FRangVar := 1
}else if(FRang == "1"){
...
IniWrite, %FRangVar%, %A_AppData%\Keybinder\DSA_Keybinder\config\Stats.ini, Fraktion, Rang
...
IniWrite, %newKills%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, KillCounter, Anzahl
return
...
IniWrite, %newDeaths%, %A_AppData%\Keybinder\DSA_Keybinder\config\Settings.ini, DeathCounter, Anzahl
return
...
SetTimer, TicketMin, Off
SetTimer, TicketSek, Off
SendChat("Ich hoffe, dass ich Dir helfen konnte und wünsche Dir noch einen schönen Tag und viel Spaß auf DSA-Roleplay!")
